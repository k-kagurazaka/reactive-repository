...
class TypeAdapterInstanceRequiredRepositoryTest {

    private val context = ApplicationProvider.getApplicationContext<Context>()
    private lateinit var preferences: SharedPreferences
    private lateinit var repository: TypeAdapterInstanceRequiredRepository

    @Before
    fun setup() {
        preferences = context.getSharedPreferences("type_adapter_instance_required_entity", Context.MODE_PRIVATE)
            .apply { edit().clear().apply() }
        repository = TypeAdapterInstanceRequiredRepositoryImpl(context, SomeClassListInstanceRequiredTypeAdapter())
    }
    ...
    fun observe() {
        ...
        val newEntity = TypeAdapterInstanceRequiredEntity(
            isVeteran = true,
            someStr = "some some",
            age = 24,
            pie = 3f,
